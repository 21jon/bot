...
function printReady() {
    ...
    console.log("");
    console.log("");
    console.log(chalk.cyan(getTime() + 'Eingeloggt als ' + client.user.tag + '.'));
...
function sendCreateTicketMessage() {
    ...
    client.channels.cache.get(config.ticketchannel).bulkDelete(100, true).then(
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .setAuthor('StationV - Ticketsystem', 'https://cdn.discordapp.com/avatars/361105590929588229/9e7b5877d83d1295977ec2dd22fb47eb.png?size=4096', '')
            .setThumbnail('https://media.discordapp.net/attachments/896415786942464031/903708952540377118/StationV.gif')
            .setDescription('Erstelle per Klick auf die Schaltfläche ein beliebiges Ticket.')
            .setTimestamp()
            .setFooter('Made with ❤️ by HxliosS#0001 & Checker Duo#0001', 'https://cdn.discordapp.com/avatars/670598870975119379/024b123d9598e2463399cb3046050d8d.png?size=4096');
        ...
        if (channeltopic.startsWith("Ticket")) {
            ...
            if(message.member.roles.cache.find(r => r.id === config.teamroleid)) {
                ...
                const embed = new Discord.MessageEmbed()
                    ...
                    .setAuthor('StationV - Ticketsystem', 'https://cdn.discordapp.com/avatars/361105590929588229/9e7b5877d83d1295977ec2dd22fb47eb.png?size=4096', '')
                    .setThumbnail('https://media.discordapp.net/attachments/896415786942464031/903708952540377118/StationV.gif')
                    .setDescription('Das Ticket wurde von <@' + message.author + '> übernommen.')
                    .setTimestamp()
                    .setFooter('Made with ❤️ by HxliosS#0001 & Checker Duo#0001', 'https://cdn.discordapp.com/avatars/670598870975119379/024b123d9598e2463399cb3046050d8d.png?size=4096');
                ...
                message.channel.send("Du besitzt keine ausreichenden Rechte, um diesen Befehl nutzen zu können.")

            }

        } else {
            message.channel.send("Dieser Channel ist kein offenes Ticket. Bitte führe den Befehl in einem Ticket-Channel aus.")
        }
    ...
    if (command === 'add') {
        ...
        if (channeltopic.startsWith("Ticket")) {
            ...
            if(message.member.roles.cache.find(r => r.id === config.teamroleid)) {
                ...
                if (args.length < 1) {
                    return message.reply('bitte nutze den Befehl wie folgt: `' + config.prefix + 'add [@User]`.');
                }
                ...
                const embed = new Discord.MessageEmbed()
                    ...
                    .setAuthor('StationV - Ticketsystem', 'https://cdn.discordapp.com/avatars/361105590929588229/9e7b5877d83d1295977ec2dd22fb47eb.png?size=4096', '')
                    .setThumbnail('https://media.discordapp.net/attachments/896415786942464031/903708952540377118/StationV.gif')
                    .setDescription('<@' + mentioneduser + '> wurde zum Ticket hinzugefügt.')
                    .setTimestamp()
                    .setFooter('Made with ❤️ by HxliosS#0001 & Checker Duo#0001', 'https://cdn.discordapp.com/avatars/670598870975119379/024b123d9598e2463399cb3046050d8d.png?size=4096');
    ...
    if (command === 'remove') {
        ...
        if (channeltopic.startsWith("Ticket")) {
            ...
            if(message.member.roles.cache.find(r => r.id === config.teamroleid)) {
                ...
                if (args.length < 1) {
                    return message.reply('bitte nutze den Befehl wie folgt: `' + config.prefix + 'remove [@User]`.');
                }
        ...
        if (channeltopic.startsWith("Ticket")) {
            ...
            if(message.member.roles.cache.find(r => r.id === config.teamroleid)) {
                ...
                const embed = new Discord.MessageEmbed()
                    ...
                    .setAuthor('StationV - Ticketsystem', 'https://cdn.discordapp.com/avatars/361105590929588229/9e7b5877d83d1295977ec2dd22fb47eb.png?size=4096', '')
                    .setThumbnail('https://media.discordapp.net/attachments/896415786942464031/903708952540377118/StationV.gif')
                    .setDescription('Das Ticket wurde von <@' + message.author + '> geschlossen.')
                    .setTimestamp()
                    .setFooter('Made with ❤️ by HxliosS#0001 & Checker Duo#0001', 'https://cdn.discordapp.com/avatars/670598870975119379/024b123d9598e2463399cb3046050d8d.png?size=4096');
                ...
                const embed2 = new Discord.MessageEmbed()
                    ...
                    .setAuthor('StationV - Ticketsystem', 'https://cdn.discordapp.com/avatars/361105590929588229/9e7b5877d83d1295977ec2dd22fb47eb.png?size=4096', '')
                    .setThumbnail('https://media.discordapp.net/attachments/896415786942464031/903708952540377118/StationV.gif')
                    .setDescription('Du kannst das Ticket jetzt löschen. Klicke dazu einfach auf den Button oder nutze den Befehl `' + config.prefix + 'delete`.')
                    .setTimestamp()
                    .setFooter('Made with ❤️ by HxliosS#0001 & Checker Duo#0001', 'https://cdn.discordapp.com/avatars/670598870975119379/024b123d9598e2463399cb3046050d8d.png?size=4096');
                setTimeout(function(){
...
client.on('clickMenu', async menu => {
    if (menu.values[0] == "menuid2") {
        ...
        let newchannel = await server.channels.create(`support-${menu.clicker.user.username}`, { type: 'text', parent: config.supportcategory, topic: `Ticket ${menu.clicker.user.username}`, permissionOverwrites: [
            {
              id: everyoneRole,
              deny: ['VIEW_CHANNEL'],
            },
        ...
        menu.reply.send("Dieser Menüpunkt dient nur der Zurücksetzung des Menüs.", true)
    }
})
...
client.on('clickMenu', async menu => {
    if (menu.values[0] == "menuid3") {
        ...
        let newchannel = await server.channels.create(`entbannung-${menu.clicker.user.username}`, { type: 'text', parent: config.entbannungcategory, topic: `Ticket ${menu.clicker.user.username}`, permissionOverwrites: [
            {
              id: everyoneRole,
              deny: ['VIEW_CHANNEL'],
            },
...
client.on('clickMenu', async menu => {
    if (menu.values[0] == "menuid4") {
        ...
        let newchannel = await server.channels.create(`spenden-${menu.clicker.user.username}`, { type: 'text', parent: config.spendencategory, topic: `Ticket ${menu.clicker.user.username}`, permissionOverwrites: [
            {
              id: everyoneRole,
              deny: ['VIEW_CHANNEL'],
            },
...
client.on('clickMenu', async menu => {
    if (menu.values[0] == "menuid5") {
        ...
        let newchannel = await server.channels.create(`erstattung-${menu.clicker.user.username}`, { type: 'text', parent: config.ruckerstattungcategory, topic: `Ticket ${menu.clicker.user.username}`, permissionOverwrites: [
            {
              id: everyoneRole,
              deny: ['VIEW_CHANNEL'],
            },
...
client.on('clickMenu', async menu => {
    if (menu.values[0] == "menuid6") {
        let server = client.guilds.cache.get(config.serverid);
        let everyoneRole = server.roles.cache.find(r => r.name === '@everyone');
        let plrole = server.roles.cache.find(r => r.id === config.teamleitungroleid);
        await menu.clicker.fetch();
        let user = menu.clicker.user;

        let newchannel = await server.channels.create(`t-anliegen-${menu.clicker.user.username}`, { type: 'text', parent: config.teamcategory, topic: `Ticket ${menu.clicker.user.username}`, permissionOverwrites: [
            {
              id: everyoneRole,
              deny: ['VIEW_CHANNEL'],
            },
...
client.on('clickMenu', async menu => {
    if (menu.values[0] == "menuid7") {
        ...
        let newchannel = await server.channels.create(`fraktion-${menu.clicker.user.username}`, { type: 'text', parent: config.frakcategory, topic: `Ticket ${menu.clicker.user.username}`, permissionOverwrites: [
            {
              id: everyoneRole,
              deny: ['VIEW_CHANNEL'],
            },
...
client.on('clickButton', async (button) => {
    ...
    if(button.id == 'closeticket') {
        ...
        const embed2 = new Discord.MessageEmbed()
            ...
            .setAuthor('StationV - Ticketsystem', 'https://cdn.discordapp.com/avatars/361105590929588229/9e7b5877d83d1295977ec2dd22fb47eb.png?size=4096', '')
            .setThumbnail('https://media.discordapp.net/attachments/896415786942464031/903708952540377118/StationV.gif')
            .setDescription('Du kannst das Ticket jetzt löschen. Klicke dazu einfach auf den Button.')
            .setTimestamp()
            .setFooter('Made with ❤️ by HxliosS#0001', 'https://cdn.discordapp.com/avatars/670598870975119379/024b123d9598e2463399cb3046050d8d.png?size=4096');
